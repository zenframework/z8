...
public class JDXLocalVariable extends JDXModificationVariable {
    ...
    public String getName() throws DebugException {
        try {
            ...
            targetRequestFailed(MessageFormat.format(JDXMessages.JDXLocalVariable_exception_retrieving_local_variable_name,
    ...
    protected void setJDXValue(Value value) throws DebugException {
        try {
            ...
            targetRequestFailed(MessageFormat.format(JDXMessages.JDXLocalVariable_exception_modifying_local_variable_value,
                    new Object[] { e.toString() }), e);
        }
    ...
    public String getReferenceTypeName() throws DebugException {
        ...
        try {
            ...
            targetRequestFailed(MessageFormat.format(
                    JDXMessages.JDXLocalVariable_exception_retrieving_local_variable_type_name,
                    new Object[] { e.toString() }), e);
            return null;
        }
    ...
    protected Type getUnderlyingType() throws DebugException {
        try {
            ...
            targetRequestFailed(MessageFormat.format(
                    JDXMessages.JDXLocalVariable_exception_while_retrieving_type_of_local_variable,
                    new Object[] { e.toString() }), e);
        }
        catch(RuntimeException e) {
            targetRequestFailed(MessageFormat.format(
