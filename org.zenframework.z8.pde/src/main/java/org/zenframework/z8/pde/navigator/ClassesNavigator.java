...
public class ClassesNavigator extends ViewPart implements ResourceListener {
    ...
    public void createPartControl(Composite parent) {
        ...
        m_viewer.addDragSupport(DND.DROP_COPY | DND.DROP_MOVE, new Transfer[] { Z8Transfer.getInstance() },
    ...
    protected void fillContextMenu(IMenuManager menu) {
        ...
        m_renameAction = new RenameAction(getSite());
        menu.add(m_renameAction);

        m_moveAction = new MoveAction(getSite());
    ...
    protected void initLabelProvider(TreeViewer viewer) {
        viewer.setLabelProvider(new DecoratingLabelProvider(new Z8LabelProvider(true), Plugin.getDefault().getWorkbench()
