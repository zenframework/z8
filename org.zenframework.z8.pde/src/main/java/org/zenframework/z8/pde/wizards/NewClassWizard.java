...
public class NewClassWizard extends BasicNewResourceWizard {
    ...
    public void addPages() {
        ...
        mainPage = new WizardNewFileCreationPage("newFilePage1", getSelection()) {
            ...
            protected InputStream getInitialContents() {
                ...
                contents += "\r\n"
                        ...
                        + "class "
                        + className
                        + (superPage.getType() != null ? " extends "
                                + superPage.getType().substring(superPage.getType().lastIndexOf('.') + 1) : "") + " {\r\n"
                        + conts + "\r\n}\r\n";
            ...
            protected boolean validatePage() {
                ...
                for(int i = 0; i < name.length(); i++) {
                    ...
                    if(c != '_' && c != 'Ё' && c != 'ё' && (c < 'а' || c > 'я') && (c < 'А' || c > 'Я')
                            && (c < '0' || c > '9') && (c < 'a' || c > 'z') && (c < 'A' || c > 'Z')) {
                        setErrorMessage("Недопустимый символ в имени файла: '" + c + "'");
                        return false;
                    }
                }
        ...
        mainPage.setTitle("Класс Z8");
        mainPage.setDescription("Создание нового класса Z8");
        addPage(mainPage);
        superPage = new NewClassExtendsPage("newFilePage2", "Выбор родительского класса",
                IDEWorkbenchPlugin.getIDEImageDescriptor("wizban/newfile_wiz.png"));
        addPage(superPage);
        extraPage = new NewClassExtraPage("newFilePage4", "Дополнительно",
                IDEWorkbenchPlugin.getIDEImageDescriptor("wizban/newfile_wiz.png"));
        addPage(extraPage);
    ...
    public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
        ...
        setWindowTitle("Создание нового класса");
    ...
    /*public void updateMethodsPage(){
    	methodsPage.update(superPage.getType());
    }*/
