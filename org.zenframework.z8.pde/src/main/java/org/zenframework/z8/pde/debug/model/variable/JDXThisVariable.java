...
public class JDXThisVariable extends JDXVariable {
    ...
    public String getSignature() throws DebugException {
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXThisVariableexception_retrieving_type_signature,
    ...
    public String getReferenceTypeName() throws DebugException {
        try {
            ...
            targetRequestFailed(MessageFormat.format(JDXMessages.JDXThisVariableexception_retrieving_reference_type_name,
                    new Object[] { e.toString() }), e);
            return null;
        }
    }
    ...
    protected Type getUnderlyingType() throws DebugException {
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXThisVariable_exception_while_retrieving_type_this,
                            new Object[] { e.toString() }), e);
        }
        return null;
    }
