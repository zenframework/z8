...
public class JDXValue extends JDXDebugElement implements IValue {
    ...
    public static JDXValue createValue(JDXDebugTarget target, JDXThread thread, JDXVariable variable, Value value) {
        ...
        if(value instanceof ObjectReference) {
            ...
            if(type != null) {
                ...
                if(typeName.equals(Primary.Boolean) || typeName.equals(Primary.Integer) || typeName.equals(Primary.Decimal)
                        || typeName.equals(Primary.Guid) || typeName.equals(Primary.Date)
                        || typeName.equals(Primary.Datetime) || typeName.equals(Primary.Datespan)) {
    ...
    public String getValueString() throws DebugException {
        ...
        if(m_value instanceof StringReference) {
            try {
                ...
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXValue_exception_retrieving_value, new Object[] { e.toString() }),
                        e);
                return null;
            }
        }
        ...
        if(m_value instanceof ObjectReference) {
            ...
            /*
            			if(m_value instanceof ClassObjectReference)
            			{
            				name.append('(');
            			...
            			name.append(" (");
            			name.append(JDXMessages.JDXValue_id_8);
            			name.append('=');
            			
            			try
            			{
            				name.append(((ObjectReference)m_value).uniqueID());
            			}
            			catch(RuntimeException e)
            			{
            				targetRequestFailed(MessageFormat.format(JDXMessages.JDXValue_exception_retrieving_unique_id, new Object[] { e.toString() }), e);
            				return null;
            			}
            			name.append(')');
            */
    ...
    public String getReferenceTypeName() throws DebugException {
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXValue_exception_retrieving_reference_type_name,
    ...
    protected synchronized List<IVariable> getVariablesList() throws DebugException {
        ...
        if(m_value instanceof ObjectReference) {
            ...
            try {
                ...
                targetRequestFailed(MessageFormat.format(JDXMessages.JDXValue_exception_retrieving_fields,
                        new Object[] { e.toString() }), e);
                return null;
            }
        ...
        if(m_allocated) {
            if(m_value instanceof ObjectReference) {
                try {
                    ...
                    targetRequestFailed(
                            MessageFormat.format(JDXMessages.JDXValue_exception_is_collected, new Object[] { e.toString() }),
                            e);
                }
            }
            else {
    ...
    public String getSignature() throws DebugException {
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXValue_exception_retrieving_type_signature,
                            new Object[] { e.toString() }), e);
            return null;
        }
    }
    ...
    protected Type getUnderlyingType() throws DebugException {
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXValue_exception_retrieving_type, new Object[] { e.toString() }), e);
            return null;
        }
    }
