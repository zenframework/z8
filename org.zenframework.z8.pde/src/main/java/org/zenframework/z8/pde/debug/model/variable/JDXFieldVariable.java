...
public class JDXFieldVariable extends JDXModificationVariable implements IVariable {
    ...
    protected void setJDXValue(Value value) throws DebugException {
        try {
            ...
            targetRequestFailed(MessageFormat.format(JDXMessages.JDXFieldVariable_exception_modifying_value,
    ...
    protected Type getUnderlyingType() throws DebugException {
        try {
            ...
            targetRequestFailed(MessageFormat.format(JDXMessages.JDXFieldVariable_exception_while_retrieving_type_of_field,
                    new Object[] { e.toString() }), e);
        }
        catch(RuntimeException e) {
            targetRequestFailed(MessageFormat.format(JDXMessages.JDXFieldVariable_exception_while_retrieving_type_of_field,
