...
public class JDXWatchpoint extends JDXLineBreakpoint {
    ...
    public JDXWatchpoint(final IResource resource, final String typeName, final String fieldName, final int lineNumber,
    ...
    protected void notSupported(String message) throws DebugException {
        throw new DebugException(new Status(IStatus.ERROR, DebugPlugin.getUniqueIdentifier(), DebugException.NOT_SUPPORTED,
                message, null));
    }
    ...
    protected ModificationWatchpointRequest createModificationWatchpoint(JDXDebugTarget target, Field field)
