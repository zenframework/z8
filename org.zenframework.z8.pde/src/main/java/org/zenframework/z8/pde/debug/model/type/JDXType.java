...
public class JDXType {
    ...
    public String getSignature() throws DebugException {
        try {
            ...
            getDebugTarget().targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXType_exception_while_retrieving_signature,
    ...
    public String getName() throws DebugException {
        try {
            ...
            getDebugTarget().targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXType_exception_while_retrieving_type_name,
                            new Object[] { e.toString() }), e);
        }
        return null;
    }
