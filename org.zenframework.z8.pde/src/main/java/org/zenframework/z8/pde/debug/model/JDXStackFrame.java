...
public class JDXStackFrame extends JDXDebugElement implements IStackFrame {
            ...
            if(m_variables == null) {
                ...
                if(method.isStatic()) {
                    ...
                    try {
                        ...
                        targetRequestFailed(
                                MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_fields,
                        ...
                        while(fields.hasNext()) {
                            ...
                            if(field.isStatic()) {
                                ...
                                if(classType != null && classType.findMember(field.name()) != null) {
                                    m_variables
                                            .add(new JDXFieldVariable(getJDXDebugTarget(), m_thread, field, declaringType));
                                }
                            }
                        }
    ...
    public List<String> getArgumentTypeNames() throws DebugException {
        try {
            ...
            targetRequestFailed(MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_argument_type_names,
                    new Object[] { e.toString() }), e);
            return null;
        }
    }
        ...
        synchronized(m_thread) {
            try {
                ...
                if(getThread().isSuspended()) {
                    targetRequestFailed(MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_line_number,
                            new Object[] { e.toString() }), e);
                }
            }
        }
                ...
                if(oldThisObject == null && thisObject != null) {
                    ...
                    if(oldThisObject != null) {
                        ...
                        if(!oldThisObject.retrieveValue().equals(thisObject)) {
                            m_variables.remove(0);
                            m_variables.add(0, new JDXThisVariable((JDXDebugTarget)getDebugTarget(), getJDXThread(),
                                    thisObject));
                        }
                        index = 1;
                    }
    ...
    protected List<LocalVariable> getUnderlyingVisibleVariables() throws DebugException {
        synchronized(m_thread) {
            ...
            try {
                ...
                targetRequestFailed(MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_visible_variables_2,
                        new Object[] { e.toString() }), e);
            }
        ...
        synchronized(m_thread) {
            if((m_stackFrame == null || m_thisObject == null)) {
                try {
                    ...
                    targetRequestFailed(
                            MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_this,
                                    new Object[] { e.toString() }), e);
                    return null;
                }
            }
    ...
    public String getSignature() throws DebugException {
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_method_signature,
                            new Object[] { e.toString() }), e);
            return null;
        }
    }
    ...
    public String getDeclaringTypeName() throws DebugException {
        synchronized(m_thread) {
            try {
                ...
                if(getThread().isSuspended()) {
                    targetRequestFailed(MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_declaring_type,
                            new Object[] { e.toString() }), e);
                }
    ...
    public String getReceivingTypeName() throws DebugException {
        if(m_stackFrame == null || m_receivingTypeName == null) {
            try {
                ...
                if(getThread().isSuspended()) {
                    targetRequestFailed(MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_receiving_type,
                            new Object[] { e.toString() }), e);
                }
    ...
    public String getMethodName() throws DebugException {
        try {
            ...
            if(getThread().isSuspended()) {
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_method_name,
                                new Object[] { e.toString() }), e);
            }
    ...
    public String getSourceName() throws DebugException {
        synchronized(m_thread) {
            try {
                ...
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_source_name,
                                new Object[] { e.toString() }), e);
            }
        }
        return null;
    ...
    public StackFrame getUnderlyingStackFrame() throws DebugException {
        synchronized(m_thread) {
            if(m_stackFrame == null) {
                if(m_depth == -1) {
                    throw new DebugException(new Status(IStatus.ERROR, JDXDebugModel.getModelIdentifier(),
                            ERR_INVALID_STACK_FRAME, JDXMessages.JDXStackFrame_25, null));
                }
                if(m_thread.isSuspended()) {
                    ...
                    throw new DebugException(new Status(IStatus.ERROR, JDXDebugModel.getModelIdentifier(),
                            JDXThread.ERR_THREAD_NOT_SUSPENDED, JDXMessages.JDXStackFrame_25, null));
                }
            }
            return m_stackFrame;
        }
    ...
    public JDXClassType getDeclaringType() throws DebugException {
        ...
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXStackFrame_exception_retreiving_declaring_type,
                            new Object[] { e.toString() }), e);
        }
        return null;
    }
    ...
    public String getSourcePath(String stratum) throws DebugException {
        synchronized(m_thread) {
            try {
                ...
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXStackFrame_exception_retrieving_source_path,
                                new Object[] { e.toString() }), e);
            }
        }
        return null;
