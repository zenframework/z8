...
public class Z8Editor extends TextEditor implements ResourceListener {
    ...
    protected void createActions() {
        ...
        IAction a = new TextOperationAction(Z8EditorMessages.getResourceBundle(), "ContentAssistProposal.", this,
                ISourceViewer.CONTENTASSIST_PROPOSALS);
        a.setActionDefinitionId(ITextEditorActionDefinitionIds.CONTENT_ASSIST_PROPOSALS);
        setAction("ContentAssistProposal", a); //$NON-NLS-1$

        a = new TextOperationAction(Z8EditorMessages.getResourceBundle(), "ContentAssistTip.", this,
        ...
        if(compilationUnit != null) {
            ...
            if(hyperlink != null) {
                for(IPosition annPos : compilationUnit.getAllHyperlinkPositions(hyperlink)) {
                    try {
                        Annotation ann = new Annotation("org.eclipse.jdt.ui.occurrences", false, getDocument().get(
                                annPos.getOffset(), annPos.getLength()));
            ...
            for(IMethod m : t.getMethods()) {
                ...
                while(sType != null) {
                    ...
                    if(m1 != null) {
                        ...
                        try {
                            Annotation ann = new OverrideAnnotation(override, sType.getCompilationUnit().getQualifiedName()
                                    + "." + m.getSignature(), m1);
