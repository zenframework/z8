...
public class JDXMapEntryVariable extends JDXModificationVariable {
    ...
    protected void setJDXValue(Value value) {
        ...
        /*		ObjectReference ar = getArrayReference();
        		...
        		if(ar == null)
        		{
        			requestFailed(JDXMessages.JDXArrayEntryVariable_value_modification_failed, null); //$NON-NLS-1$
        		}
        		...
        		{
        			targetRequestFailed(MessageFormat.format(JDXMessages.JDXArrayEntryVariable_exception_modifying_variable_value, new Object[] { e.toString() }), e);
        		}
    ...
    protected Type getUnderlyingType() throws DebugException {
        try {
            ...
            targetRequestFailed(MessageFormat.format(
                    JDXMessages.JDXArrayEntryVariable_exception_while_retrieving_type_of_array_entry,
