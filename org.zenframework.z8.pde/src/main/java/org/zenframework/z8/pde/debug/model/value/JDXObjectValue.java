...
public class JDXObjectValue extends JDXValue {
    ...
    public IVariable getField(String name, boolean superField) throws DebugException {
        ...
        try {
            ...
            return ((JDXObjectValue)(new JDXFieldVariable((JDXDebugTarget)getDebugTarget(), getJDXThread(), enclosingThis,
                    getUnderlyingObject())).getValue()).getField(name, false);
        }
        catch(RuntimeException e) {
            targetRequestFailed(MessageFormat.format(JDXMessages.JDXObjectValue_exception_retrieving_field,
    ...
    protected ReferenceType getUnderlyingReferenceType() throws DebugException {
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXObjectValue_exception_retrieving_reference_type,
                            new Object[] { e.toString() }), e);
        }
        return null;
    }
        ...
        for(int i = 0; i < enclosingLevel; i++) {
            ...
            try {
                ...
                if(enclosingThis != null) {
                    res = (JDXObjectValue)(new JDXFieldVariable((JDXDebugTarget)getDebugTarget(), getJDXThread(),
                            enclosingThis, res.getUnderlyingObject())).getValue();
                }
                else {
                    return null;
                }
                ...
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXObjectValue_exception_retrieving_field,
                                new Object[] { e.toString() }), e);
            }
        }
        return res;
