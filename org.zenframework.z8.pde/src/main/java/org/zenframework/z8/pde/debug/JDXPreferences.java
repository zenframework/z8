...
public interface JDXPreferences {
    public static final String PREF_SUSPEND_ON_UNCAUGHT_EXCEPTIONS = Plugin.PLUGIN_ID
            + "javaDebug.SuspendOnUncaughtExceptions";
    /**
     ...
     * <li><code>INLINE_FORMATTERS</code> to show inline details for
     * variables with formatters
     ...
     */
    public static final String PREF_ALERT_UNABLE_TO_INSTALL_BREAKPOINT = Plugin.PLUGIN_ID
            + ".prompt_unable_to_install_breakpoint";
