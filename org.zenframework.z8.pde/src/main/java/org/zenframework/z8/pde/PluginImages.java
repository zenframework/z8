...
public class PluginImages {
    ...
    public static final String IMG_OBJS_FIXABLE_PROBLEM = NAME_PREFIX + "quickfix_warning_obj.gif";
    ...
    public static final ImageDescriptor DESC_ELCL_VIEW_MENU = createManaged(T_ELCL, NAME_PREFIX + "view_menu.gif", IMG_ELCL_VIEW_MENU);
    public static final ImageDescriptor DESC_DLCL_VIEW_MENU = createManaged(T_DLCL, NAME_PREFIX + "view_menu.gif", IMG_DLCL_VIEW_MENU);
    ...
    public static final ImageDescriptor DESC_ELCL_CLEAR = create(T_ELCL, "clear_co.gif");
    public static final ImageDescriptor DESC_DLCL_CLEAR = create(T_DLCL, "clear_co.gif");
    ...
    public static final ImageDescriptor DESC_DLCL_TEXT_EDIT = create(T_DLCL, "text_edit.gif");
    ...
    public static final ImageDescriptor DESC_OBJS_ACCESSRULES_ATTRIB = create(T_OBJ, "access_restriction_attrib.gif");
    public static final ImageDescriptor DESC_OBJS_NATIVE_LIB_PATH_ATTRIB = create(T_OBJ, "native_lib_path_attrib.gif");
    ...
    public static final ImageDescriptor DESC_OBJS_TYPE_SEPARATOR = create(T_OBJ, "type_separator.gif");
    ...
    public static final ImageDescriptor DESC_ELCL_ADD_TO_BP = create(T_ELCL, "add_to_buildpath.gif");
    public static final ImageDescriptor DESC_ELCL_REMOVE_FROM_BP = create(T_ELCL, "remove_from_buildpath.gif");
    public static final ImageDescriptor DESC_ELCL_INCLUSION = create(T_ELCL, "inclusion_filter_attrib.gif");
    public static final ImageDescriptor DESC_ELCL_EXCLUSION = create(T_ELCL, "exclusion_filter_attrib.gif");
    // public static final ImageDescriptor DESC_ELCL_INCLUSION_UNDO=
    // create(T_ELCL, "inclusion_filter_attrib_undo.gif");
    // public static final ImageDescriptor DESC_ELCL_EXCLUSION_UNDO=
    // create(T_ELCL, "exclusion_filter_attrib_undo.gif");
    public static final ImageDescriptor DESC_DLCL_ADD_TO_BP = create(T_DLCL, "add_to_buildpath.gif");
    public static final ImageDescriptor DESC_DLCL_REMOVE_FROM_BP = create(T_DLCL, "remove_from_buildpath.gif");
    public static final ImageDescriptor DESC_DLCL_INCLUSION = create(T_DLCL, "inclusion_filter_attrib.gif");
    public static final ImageDescriptor DESC_DLCL_EXCLUSION = create(T_DLCL, "exclusion_filter_attrib.gif");
    public static final ImageDescriptor DESC_DLCL_OUTPUT_FOLDER_ATTRIB = create(T_DLCL, "output_folder_attrib.gif");
    // public static final ImageDescriptor DESC_DLCL_INCLUSION_UNDO=
    // create(T_DLCL, "inclusion_filter_attrib_undo.gif");
    // public static final ImageDescriptor DESC_DLCL_EXCLUSION_UNDO=
    // create(T_DLCL, "exclusion_filter_attrib_undo.gif");
    public static final ImageDescriptor DESC_DLCL_ADD_LINKED_SOURCE_TO_BUILDPATH = create(T_DLCL, "add_linked_source_to_buildpath.gif");
    public static final ImageDescriptor DESC_ELCL_ADD_LINKED_SOURCE_TO_BUILDPATH = create(T_ELCL, "add_linked_source_to_buildpath.gif");
    public static final ImageDescriptor DESC_DLCL_CONFIGURE_BUILDPATH = create(T_DLCL, "configure_build_path.gif");
    public static final ImageDescriptor DESC_ELCL_CONFIGURE_BUILDPATH = create(T_ELCL, "configure_build_path.gif");
    public static final ImageDescriptor DESC_DLCL_CONFIGURE_BUILDPATH_FILTERS = create(T_DLCL, "configure_buildpath_filters.gif");
    public static final ImageDescriptor DESC_ELCL_CONFIGURE_BUILDPATH_FILTERS = create(T_ELCL, "configure_buildpath_filters.gif");
    public static final ImageDescriptor DESC_DLCL_CONFIGURE_OUTPUT_FOLDER = create(T_DLCL, "configure_output_folder.gif");
    public static final ImageDescriptor DESC_ELCL_CONFIGURE_OUTPUT_FOLDER = create(T_ELCL, "configure_output_folder.gif");
    public static final ImageDescriptor DESC_DLCL_EXCLUDE_FROM_BUILDPATH = create(T_DLCL, "exclude_from_buildpath.gif");
    public static final ImageDescriptor DESC_ELCL_EXCLUDE_FROM_BUILDPATH = create(T_ELCL, "exclude_from_buildpath.gif");
    public static final ImageDescriptor DESC_DLCL_INCLUDE_ON_BUILDPATH = create(T_DLCL, "include_on_buildpath.gif");
    public static final ImageDescriptor DESC_ELCL_INCLUDE_ON_BUILDPATH = create(T_ELCL, "include_on_buildpath.gif");
    public static final ImageDescriptor DESC_DLCL_ADD_AS_SOURCE_FOLDER = create(T_DLCL, "add_as_source_folder.gif");
    public static final ImageDescriptor DESC_ELCL_ADD_AS_SOURCE_FOLDER = create(T_ELCL, "add_as_source_folder.gif");
    public static final ImageDescriptor DESC_DLCL_REMOVE_AS_SOURCE_FOLDER = create(T_DLCL, "remove_as_source_folder.gif");
    public static final ImageDescriptor DESC_ELCL_REMOVE_AS_SOURCE_FOLDER = create(T_ELCL, "remove_as_source_folder.gif");
    ...
    public static final ImageDescriptor DESC_WIZBAN_NEWENUM = create(T_WIZBAN, "newenum_wiz.gif");
    public static final ImageDescriptor DESC_WIZBAN_NEWANNOT = create(T_WIZBAN, "newannotation_wiz.gif");
    ...
    public static final ImageDescriptor DESC_DLCL_NEWPACKROOT = create(T_DLCL, "newpackfolder_wiz.gif");
    public static final ImageDescriptor DESC_TOOL_CLASSPATH_ORDER = create(T_OBJ, "cp_order_obj.gif");
    public static final ImageDescriptor DESC_ELCL_COLLAPSEALL = create(T_ELCL, "collapseall.gif");
