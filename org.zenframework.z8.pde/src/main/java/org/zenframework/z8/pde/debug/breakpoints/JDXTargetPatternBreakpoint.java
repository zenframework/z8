...
public class JDXTargetPatternBreakpoint extends JDXLineBreakpoint {
    ...
    public JDXTargetPatternBreakpoint(IResource resource, String sourceName, int lineNumber, int javaLineNumber,
            int charStart, int charEnd, int hitCount, boolean add, Map<String, Object> attributes) throws DebugException {
        this(resource, sourceName, lineNumber, javaLineNumber, charStart, charEnd, hitCount, add, attributes,
                TARGET_PATTERN_BREAKPOINT);
    }

    public JDXTargetPatternBreakpoint(final IResource resource, final String sourceName, final int lineNumber,
