    ...
    public JDXType getSuperclass() throws DebugException {
        try {
            ...
            getDebugTarget().targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXClassType_exception_while_retrieving_superclass,
        ...
        try {
            ...
            while(iterator.hasNext()) {
                ...
                if(interfaceType != null) {
                    jdxInterfaceTypeList.add(JDXType.createType(getDebugTarget(), getJDXThread(), getJDXVariable(),
                            interfaceType));
                }
            }
