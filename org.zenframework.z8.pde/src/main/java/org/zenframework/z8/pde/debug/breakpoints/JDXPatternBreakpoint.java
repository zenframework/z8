...
public class JDXPatternBreakpoint extends JDXLineBreakpoint {
    ...
    public JDXPatternBreakpoint(IResource resource, String sourceName, String pattern, int lineNumber, int javaLineNumber,
            int charStart, int charEnd, int hitCount, boolean add, Map<String, Object> attributes) throws DebugException {
        this(resource, sourceName, pattern, lineNumber, javaLineNumber, charStart, charEnd, hitCount, add, attributes,
                PATTERN_BREAKPOINT);
    }

    public JDXPatternBreakpoint(final IResource resource, final String sourceName, final String pattern,
            final int lineNumber, final int javaLineNumber, final int charStart, final int charEnd, final int hitCount,
            final boolean add, final Map<String, Object> attributes, final String markerType) throws DebugException {
        ...
        if(getSourceName() != null) {
            ...
            try {
                ...
                target.targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXPatternBreakpoint_exception_source_name,
                                new Object[] { e.toString(), type.name() }), e);
                return false;
            }
