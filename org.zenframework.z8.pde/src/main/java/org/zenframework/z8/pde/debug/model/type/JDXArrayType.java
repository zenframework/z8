...
public class JDXArrayType extends JDXReferenceType {
    ...
    public IIndexedValue newInstance(int size) throws DebugException {
        try {
            ...
            getDebugTarget().targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXArrayType_exception_while_creating_new_instance_of_array,
    ...
    public JDXType getComponentType() throws DebugException {
        try {
            ...
            getDebugTarget().targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXArrayType_exception_while_retrieving_component_type_of_array,
                            new Object[] { e.toString() }), e);
        }
        catch(RuntimeException e) {
            getDebugTarget().targetRequestFailed(
