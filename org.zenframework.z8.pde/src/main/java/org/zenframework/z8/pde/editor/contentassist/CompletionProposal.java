...
/**
 * Отличие от класса <code>ICompletionProposal</code> в добавлении методов setReplacementLength() и getReplacementString().
 */
public final class CompletionProposal implements ICompletionProposal {
    ...
    public void setReplacementLength(int len) {
