...
public class ReconcileMessageConsumer extends DefaultBuildMessageConsumer {
        ...
        public void doAction(AnnotationModel model) {
            ...
            while(iterator.hasNext()) {
                ...
                if(type.equals("org.eclipse.ui.workbench.texteditor.error")
                        || type.equals("org.eclipse.ui.workbench.texteditor.warning")) {
    ...
    private void doConsume(AnnotationModel model, BuildMessage message) {
        ...
        Annotation annotation = new Annotation(message instanceof BuildError ? "org.eclipse.ui.workbench.texteditor.error"
                : "org.eclipse.ui.workbench.texteditor.warning", false, text);
