...
public class JDXThread extends JDXDebugElement implements IThread {
    ...
    private List<StackFrame> getUnderlyingFrames() throws DebugException {
        if(!isSuspended()) {
            requestFailed(JDXMessages.JDXThread_Unable_to_retrieve_stack_frame___thread_not_suspended__1, null,
                    JDXThread.ERR_THREAD_NOT_SUSPENDED);
        }
        try {
            return getUnderlyingThread().frames();
        }
        catch(IncompatibleThreadStateException e) {
            requestFailed(JDXMessages.JDXThread_Unable_to_retrieve_stack_frame___thread_not_suspended__1, e,
                    JDXThread.ERR_THREAD_NOT_SUSPENDED);
        }
        catch(RuntimeException e) {
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXThread_exception_retrieving_stack_frames_2,
    ...
    protected int getUnderlyingFrameCount() throws DebugException {
        try {
            ...
            targetRequestFailed(MessageFormat.format(JDXMessages.JDXThread_exception_retrieving_frame_count,
                    new Object[] { e.toString() }), e);
        }
        catch(IncompatibleThreadStateException e) {
            requestFailed(MessageFormat.format(JDXMessages.JDXThread_exception_retrieving_frame_count,
                    new Object[] { e.toString() }), e, JDXThread.ERR_THREAD_NOT_SUSPENDED);
        }
        return -1;
    }
    ...
    public String getName() throws DebugException {
        try {
            ...
            if(e instanceof ObjectCollectedException) {
                ...
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXThread_exception_retrieving_thread_name,
                                new Object[] { e.toString() }), e);
            }
        }
    ...
    public int getPriority() throws DebugException {
        ...
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXThread_exception_retrieving_thread_priority,
                            new Object[] { e.toString() }), e);
        }
    ...
    public String getThreadGroupName() throws DebugException {
        if(fThreadGroupName == null) {
            ...
            try {
                ...
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXThread_exception_retrieving_thread_group_name,
                                new Object[] { e.toString() }), e);
                return null;
            }
        }
    ...
    public IType getType(Location location) {
        if(location != null) {
            try {
                ...
                if(sourcePath != null) {
                    String qualifiedName = new Path(sourcePath).removeFileExtension().toString()
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if(!suspended) {
                        IStatus status = new Status(IStatus.ERROR, Plugin.getUniqueIdentifier(), SUSPEND_TIMEOUT,
                                MessageFormat.format(JDXMessages.JDXThread_suspend_timeout, new Object[] { new Integer(
                                        timeout).toString() }), null);
    ...
    protected ThreadGroupReference getUnderlyingThreadGroup() throws DebugException {
        if(fThreadGroup == null) {
            try {
                ...
                requestFailed(
                        MessageFormat.format(JDXMessages.JDXThread_exception_retrieving_thread_group,
                                new Object[] { e.toString() }), e);
                return null;
            }
            catch(RuntimeException e) {
    ...
    abstract class StepHandler implements JDXEventListener {
        ...
        protected void invokeThread() throws DebugException {
            try {
                ...
                stepEnd();
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXThread_exception_stepping, new Object[] { e.toString() }), e);
            }
        }
        ...
        protected StepRequest createStepRequest() throws DebugException {
            ...
            try {
                ...
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXThread_exception_creating_step_request,
                                new Object[] { e.toString() }), e);
            }
            return null;
        }
        ...
        public IStatus run(IProgressMonitor monitor) {
            ...
            while(i < runnables.length && !fJDXThread.isTerminated() && !monitor.isCanceled()) {
                try {
                    ...
                    if(failed == null) {
                        failed = new MultiStatus(Plugin.getUniqueIdentifier(), JDXDebug.INTERNAL_ERROR,
                                JDXMessages.JDXThread_0, null);
                    }
                    failed.add(new Status(IStatus.ERROR, Plugin.getUniqueIdentifier(), JDXDebug.INTERNAL_ERROR,
                            JDXMessages.JDXThread_0, e));
                }
                i++;
                monitor.worked(1);
            }
    ...
    public void stop(IValue exception) throws DebugException {
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXThread_exception_stoping_thread, new Object[] { e.toString() }), e);
        }
    }
}
