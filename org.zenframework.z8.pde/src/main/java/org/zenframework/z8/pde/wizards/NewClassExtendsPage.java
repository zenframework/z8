...
public class NewClassExtendsPage extends WizardPage {
    ...
    public void createControl(Composite parent) {
        ...
        label1.setText("Выберите тип класса:");
        ...
        label.setText("Фильтр по имени родительского класса:");
        ...
        label.setText("Фильтр по базовому классу:");
        otherControls.add(label);
        ...
        label = new Label(topLevel, SWT.NONE);
        label.setText("Родительский класс:");
        otherControls.add(label);
    ...
    private void updateList() {
        ...
        for(int i = 0; i < size; i++)
            strings[i] = currentTypes[i].getUserName()/* + " - " + currentTypes[i].getCompilationUnit().getPackage()*/;
