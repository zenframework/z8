...
public class Z8LabelProvider extends LabelProvider implements ILightweightLabelDecorator {
    ...
    public static Image loadImage(String path) {
        try {
            Image originalImage = new Image((Device)null, FileLocator.openStream(Plugin.getDefault().getBundle(), new Path(
                    path), true));
    ...
    public String getText(Object object) {
        ...
        if(element instanceof MemberNestedType) {
            ...
            Plugin.log(new Status(IStatus.ERROR, Plugin.PLUGIN_ID, 0, "Unknown language element "
                    + element.getClass().getName(), null));
        }
