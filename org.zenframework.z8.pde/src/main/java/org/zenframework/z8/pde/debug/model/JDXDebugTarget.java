...
public class JDXDebugTarget extends JDXDebugElement implements IDebugTarget, ILaunchListener, IBreakpointManagerListener,
    ...
    public JDXDebugTarget(ILaunch launch, VirtualMachine jvm, String name, boolean supportTerminate,
    ...
    public void disconnect() throws DebugException {
        ...
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXDebugTarget_exception_disconnecting, new Object[] { e.toString() }),
                    e);
        }
    }
    ...
    public String getName() throws DebugException {
        if(m_name == null) {
            ...
            try {
                ...
                targetRequestFailed(
                        MessageFormat.format(JDXMessages.JDXDebugTarget_exception_retrieving_name,
    ...
    public ClassPrepareRequest createClassPrepareRequest(String classPattern, String classExclusionPattern, boolean enabled)
            throws CoreException {
    ...
    protected void resume(boolean fireNotification) throws DebugException {
        ...
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXDebugTarget_exception_resume, new Object[] { e.toString() }), e);
        }
    }
    ...
    public void suspend() throws DebugException {
        ...
        try {
            ...
            fireResumeEvent(DebugEvent.CLIENT_REQUEST);
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXDebugTarget_exception_suspend, new Object[] { e.toString() }), e);
        }
    }
    ...
    public void terminate() throws DebugException {
        ...
        try {
            ...
            targetRequestFailed(
                    MessageFormat.format(JDXMessages.JDXDebugTarget_exception_terminating, new Object[] { e.toString() }), e);
        }
    }
    ...
    public void handleDebugEvents(DebugEvent[] events) {
        if(events.length == 1) {
            ...
            if(event.getSource() == this && event.getKind() == DebugEvent.CREATE) {
                JDXEventDispatcher dispatcher = getJDXDebugTarget().getEventDispatcher();
                if(dispatcher != null) {
                    Thread t = new Thread(dispatcher, JDXDebugModel.getModelIdentifier()
                            + JDXMessages.JDXDebugTarget_JDX_Event_Dispatcher);
                    t.setDaemon(true);
                    t.start();
                }
            }
