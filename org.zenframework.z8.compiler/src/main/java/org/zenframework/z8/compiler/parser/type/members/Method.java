...
public class Method extends AbstractMethod implements IMethod {
	...
	public Method(IVariableType type, IToken nameToken, Variable[] parameters, IToken leftBrace, IToken rightBrace) {
	...
	public Method(IVariableType type, String name, Variable[] parameters) {
