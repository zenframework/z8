...
public class Declarator extends Initialization implements IVariable, IStatement {
    ...
    public Declarator(IToken finalToken, VariableType variableType, IToken nameToken, OperatorToken operatorToken,
            ILanguageElement initializer) {
    ...
    public boolean resolveTypes(CompilationUnit compilationUnit, IType declaringType) {
        ...
        if(!Lexer.checkIdentifier(getName())) {
            setFatalError(getNameToken().getPosition(), "Syntax error on token '" + name + "'. " + name
    ...
    public boolean resolveNestedTypes(CompilationUnit compilationUnit, IType declaringType) {
        return variableType.resolveNestedTypes(compilationUnit, declaringType)
                && super.resolveTypes(compilationUnit, declaringType)
                && super.resolveNestedTypes(compilationUnit, declaringType);
    }
