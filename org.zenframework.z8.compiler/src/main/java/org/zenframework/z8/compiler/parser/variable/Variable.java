...
public class Variable extends LanguageElement implements IVariable {
	...
	public boolean resolveStructure(CompilationUnit compilationUnit, IType declaringType) {
		...
		return super.resolveStructure(compilationUnit, declaringType) && variableType.resolveStructure(compilationUnit, declaringType);
	}
	...
	public boolean checkSemantics(CompilationUnit compilationUnit, IType declaringType, IMethod declaringMethod, IVariable leftHandValue, IVariableType context) {
		...
		return super.checkSemantics(compilationUnit, declaringType, declaringMethod, null, null) && variableType.checkSemantics(compilationUnit, declaringType, declaringMethod, null, null);
	}
