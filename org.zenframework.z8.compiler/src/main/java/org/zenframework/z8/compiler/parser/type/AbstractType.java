...
public abstract class AbstractType extends LanguageElement implements IType {
    ...
    public boolean equals(Object object) {
        ...
        if(object instanceof IType) {
            ...
            return getCompilationUnit() == type.getCompilationUnit() && userName != null
                    && userName.equals(type.getUserName());
    ...
    public IMethod[] getMatchingMethods(String name, int parametersCount) {
        ...
        while(type != null) {
            ...
            for(IMethod method : methods) {
                if(!method.getName().equals(name) || parametersCount != -1 && parametersCount != method.getParametersCount()
                        || result.get(method) != null) {
                    continue;
                }
