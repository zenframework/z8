Z8.define('Z8.form.Helper', {
	statics: {
		...
		createControl: function(field) {
			...
			var label = Z8.isEmpty(field.label) || (field.label !== false && field.label.align !== 'none') ? { text: field.header || field.text, icon: field.icon, align: (!Z8.isEmpty(field.label.align) ? field.label.align : null) || (field.type != Type.Boolean ? 'top' : 'right') } : false;
