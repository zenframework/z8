Z8.define('Z8.calendar.Period', {
	...
	htmlMarkup: function() {
		...
		var dayBeforeYesterday = new Z8.button.Button({ text: Z8.$('Period.dayBeforeYesterday'), name: 'dayBeforeYesterday', toggled: false });
		var last7Days = new Z8.button.Button({ text: Z8.$('Period.sevenDays'), name: 'last7Days', toggled: false });
		var tomorrow = new Z8.button.Button({ text: Z8.$('Period.tomorrow'), name: 'tomorrow', toggled: false });

		var separator = { cls: 'separator' };

		var thisWeek = new Z8.button.Button({ text: Z8.$('Period.thisWeek'), name: 'thisWeek', toggled: false });
		var lastWeek = new Z8.button.Button({ text: Z8.$('Period.lastWeek'), name: 'lastWeek', toggled: false });
		var nextWeek = new Z8.button.Button({ text: Z8.$('Period.nextWeek'), name: 'nextWeek', toggled: false });

		var thisMonth = new Z8.button.Button({ text: Z8.$('Period.thisMonth'), name: 'thisMonth', toggled: false });
		var lastMonth = new Z8.button.Button({ text: Z8.$('Period.lastMonth'), name: 'lastMonth', toggled: false });
		var nextMonth = new Z8.button.Button({ text: Z8.$('Period.nextMonth'), name: 'nextMonth', toggled: false });
		...
		var thisQuarter = new Z8.button.Button({ text: Z8.$('Period.thisQuarter'), name: 'thisQuarter', toggled: false });
		var lastQuarter = new Z8.button.Button({ text: Z8.$('Period.lastQuarter'), name: 'lastQuarter', toggled: false });
		var nextQuarter = new Z8.button.Button({ text: Z8.$('Period.nextQuarter'), name: 'nextQuarter', toggled: false });

		var thisHalfYear = new Z8.button.Button({ text: Z8.$('Period.thisHalfAYear'), name: 'thisHalfYear', toggled: false });
		var lastHalfYear = new Z8.button.Button({ text: Z8.$('Period.lastHalfAYear'), name: 'lastHalfYear', toggled: false });
		var nextHalfYear = new Z8.button.Button({ text: Z8.$('Period.nextHalfAYear'), name: 'nextHalfYear', toggled: false });

		var thisYear = new Z8.button.Button({ text: Z8.$('Period.thisYear'), name: 'thisYear', toggled: false });
		var lastYear = new Z8.button.Button({ text: Z8.$('Period.lastYear'), name: 'lastYear', toggled: false });
		var nextYear = new Z8.button.Button({ text: Z8.$('Period.nextYear'), name: 'nextYear', toggled: false });
		...
		var cancel = new Z8.button.Button({ text: Z8.$('Period.close'), push: true, handler: this.onCancel, scope: this });
		var ok = new Z8.button.Button({ text: Z8.$('Period.apply'), push: true, primary: true, handler: this.onApply, scope: this });
