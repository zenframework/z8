...
Z8.PeriodButton = Ext.extend(Z8.SplitButton, {
	...
	initComponent: function() {
		...
		this.start = Ext.isDate(this.start) ? this.start : (!Ext.isEmpty(this.start) ? new Date(this.start) : new Date())/*Date.parseDate(this.start, Z8.Format.Date)*/;
		this.finish = Ext.isDate(this.finish) ? this.finish : (!Ext.isEmpty(this.finish) ? new Date(this.finish) : new Date())/*Date.parseDate(this.finish, Z8.Format.Date)*/;
	...
	getPeriod: function() {
		return { start: Z8.Format.isoDate(this.start), finish: Z8.Format.isoDate(this.finish), period: this.period };
	},
