...
if(Ext.form.DateField){
  Ext.apply(Ext.form.DateField.prototype, {
	...
	minText		   : "Дата в этом поле должна быть раньше {0}",
	maxText		   : "Дата в этом поле должна быть позже {0}",
	invalidText	   : "{0} не является правильной датой - дата должна быть указана в формате 'dd/mm/yyyy'",
	format			: "d.m.y",
