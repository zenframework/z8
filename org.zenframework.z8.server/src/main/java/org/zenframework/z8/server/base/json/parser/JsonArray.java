...
public class JsonArray extends OBJECT {
	...
	public bool z8_contains(primary value) {
		return new bool(CollectionUtils.contains(getInternalArray(), value, null));
	}

	public bool z8_contains(JsonObject.CLASS<? extends JsonObject> value, string compareKey) {
		return new bool(CollectionUtils.contains(getInternalArray(), value.get().getInternalObject(), compareKey.get()));
	}
	...
	public static JsonArray.CLASS<JsonArray> z8_diff(JsonArray.CLASS<? extends JsonArray> a1,
			JsonArray.CLASS<? extends JsonArray> a2, string compareKey) {
