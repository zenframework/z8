...
public class Distance extends SqlToken {
	private final SqlToken geometry1, geometry2;

	public Distance(SqlToken geometry1, SqlToken geometry2) {
	...
	public String format(DatabaseVendor vendor, FormatOptions options, boolean logicalContext) {
		switch (vendor) {
		case Postgres:
			return new StringBuilder(1024).append("ST_Distance(").append(geometry1.format(vendor, options)).append(", ")
