...
public class Messenger extends RequestTarget {
	...
	private static Map<String, UserOnlineInfo> usersOnline = Collections.synchronizedMap(new HashMap<String, UserOnlineInfo>());

	private static Map<String, List<Message>> newMessages = Collections.synchronizedMap(new HashMap<String, List<Message>>());
	...
	public void writeResponse(JsonWriter writer) {
		...
		String type = getParameter(Json.message);
		...
		if(Json.get.equals(type)) {
			...
			JsonArray recipients = new JsonArray(getParameter(Json.recipient));
	...
	private void sendMessage(String recipient) {
		...
		Message message = new Message(userName, senderEmail, recipient, recipientEmail, getParameter(Json.text));
