...
import org.zenframework.z8.server.db.sql.functions.datetime.TotalHour;
import org.zenframework.z8.server.db.sql.functions.datetime.TotalMinute;
import org.zenframework.z8.server.db.sql.functions.datetime.TotalSecond;
...
public class sql_datespan extends sql_primary {
    ...
    public sql_datetime operatorAdd(sql_date value) {
        return new sql_datetime(new Add(this, Operation.Add, value));
    }

    public sql_datetime operatorAdd(sql_datetime value) {
        return new sql_datetime(new Add(this, Operation.Add, value));
    }
