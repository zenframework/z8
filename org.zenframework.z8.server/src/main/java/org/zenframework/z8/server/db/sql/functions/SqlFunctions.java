...
public class SqlFunctions {
    ...
    static public sql_datetime z8_IIF(sql_bool value, sql_datetime yes, sql_datetime no) {
        return value.z8_IIF(yes, no);
    }
    ...
    static public sql_datetime z8_NVL(sql_datetime value, sql_datetime variants) {
        return new sql_datetime(new Nvl(value, variants));
    }
    ...
    static public sql_bool z8_inVector(sql_datetime value, RCollection<datetime> variants) {
        return new sql_bool(new InVector(value, variants));
    }
