...
public class ExpressionLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "T__22", "INTEGER_LITERAL", 
			"FLOAT_LITERAL", "BOOL_LITERAL", "STRING_LITERAL", "IDENTIFIER", "ExponentPart", 
			"EscapeSequence", "HexDigits", "HexDigit", "Digits", "Letter", "LetterOrDigit", 
			"WS"
		};
	}
