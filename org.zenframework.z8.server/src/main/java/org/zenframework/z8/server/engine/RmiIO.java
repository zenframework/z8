...
public class RmiIO extends ObjectIO {
	...
	protected void writeObject(ObjectOutputStream out, Object replacement, Object value) throws IOException {
		if(value == null) {
		...
		} else if(value instanceof RemoteStub) {
			out.writeInt(RmiSerializable.RemoteStub);
			writeRemoteStub(out, (RemoteStub)value);
			...
			RuntimeException e = new RuntimeException("Object (" + value.getClass().getCanonicalName() + ") is not an instance of z8.rmi.RmiSerializable");
	...
	protected Object readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
		...
		if(id == RmiSerializable.Null)
			...
			return readProxy(in);
		else if(id == RmiSerializable.RemoteStub)
