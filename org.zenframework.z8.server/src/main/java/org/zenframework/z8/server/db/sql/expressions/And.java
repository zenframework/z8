...
public class And extends Expression {
    ...
    public String format(DatabaseVendor vendor, FormatOptions options, boolean logicalContext) {
        if(logicalContext) {
            SqlToken left = this.left instanceof True ? null : (this.left instanceof Group ? this.left
                    : new Group(this.left));
            SqlToken right = this.right instanceof True ? null : (this.right instanceof Group ? this.right : new Group(
                    this.right));
