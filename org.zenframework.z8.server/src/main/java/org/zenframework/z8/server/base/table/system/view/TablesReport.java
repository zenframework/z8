...
import org.zenframework.z8.server.base.form.action.ActionReport;
...
public class TablesReport extends Report {
    ...
    private static final File TemplateFile = new File(Folders.Base, "reports/system/Tables.odt");
    ...
    protected file execute(guid recordId) {
        ...
        file fileOut = file.createTempFile("test", "odt");
        try {
