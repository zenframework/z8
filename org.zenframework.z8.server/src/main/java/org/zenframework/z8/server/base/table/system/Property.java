...
public class Property extends OBJECT {
	...
	public String toString() {
		return new StringBuilder(1024).append("Property[").append(getId()).append(", ").append(getKey()).append(", ").append(getDefaultValue()).append(", ").append(getDescription()).append(']').toString();
	}
