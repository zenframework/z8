...
public class JsonField extends TextField {
	...
	public org.zenframework.z8.server.json.parser.JsonObject getJsonObject() {
		...
		return value.isEmpty() ? new org.zenframework.z8.server.json.parser.JsonObject() : new org.zenframework.z8.server.json.parser.JsonObject(get().toString());
	}

	public org.zenframework.z8.server.json.parser.JsonArray getJsonArray() {
		String value = get().toString();
		return value.isEmpty() ? new org.zenframework.z8.server.json.parser.JsonArray() : new org.zenframework.z8.server.json.parser.JsonArray(get().toString());
	}
